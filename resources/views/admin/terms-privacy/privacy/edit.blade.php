...
@section('page-subtitle', 'Update Privacy Policy')
                    ...
                    <form action="{{ route('admin.privacy-policy.update', $privacyPolicy->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" value="{{ old('title', $privacyPolicy->title) }}" required>
                            @error('title')
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                    value="1" {{ old('is_active', $privacyPolicy->is_active) ? 'checked' : '' }}>
