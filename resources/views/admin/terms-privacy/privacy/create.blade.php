...
@section('page-title', 'Create Privacy Policy')
@section('page-subtitle', 'Create a new Privacy Policy')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Create Privacy Policy</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.privacy-policy.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                                name="title" value="{{ old('title', 'Privacy Policy') }}" required>
                            @error('title')
