...
@section('page-subtitle', 'Add a new discount coupon')
    ...
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror"
                                        id="code" name="code" value="{{ old('code', request()->get('code')) }}"
                                        required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01"
                                    ...
                                    name="discount_value" value="{{ old('discount_value') }}" required>
                            ...
                            <div class="col-md-6 mb-3 d-flex align-items-center">
                                ...
                                <div class="form-check form-switch ms-4">
                                    <input class="form-check-input" type="checkbox" id="for_new_users_only"
                                        ...
                                        {{ old('for_new_users_only') ? 'checked' : '' }}>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="small mb-0">
                        <li>Use a short, memorable code (e.g., SAVE10).</li>
                        <li>Set a valid date range to control usage.</li>
                        <li>Limit usage for special campaigns.</li>
                        <li>New users only coupons increase first-time orders.</li>
                    </ul>
                </div>
            </div>
        </div>
